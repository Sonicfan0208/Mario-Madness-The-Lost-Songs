...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		overlaybw = new FlxSprite().loadGraphic(Paths.image('modstuff/pause/pauseoverlay'));
		overlaybw.setGraphicSize(Std.int(descArrow.width * 3.71));
		overlaybw.alpha = 0;
		overlaybw.visible = blackandwhite;
