...
class ClientPrefs {
	...
	public static var storyPassv1:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.storyPassv1 = storyPassv1;
	...
	public static function loadPrefs() {
		...
		if (FlxG.save.data.storyPassv1 != null) {
			storyPassv1 = FlxG.save.data.storyPassv1;
		}
