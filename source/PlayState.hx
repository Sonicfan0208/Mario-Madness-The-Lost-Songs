...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'exesequel': // Mario.exe Classic
				...
				peachCuts = new BGSprite('characters/Peach_EXE_Cuts', -160, -100, 1, 1, ["PeachFalling"], true);
			...
			case 'warioworld':
				...
				if(PlayState.SONG.song != 'Apparition Old' && PlayState.SONG.song != 'Forbidden Star' && PlayState.SONG.song != 'Apparition'){
			...
			case 'virtual':
				...
				addCharacterToList('vDialog', 1);
				addCharacterToList('vGF', 1);
		...
		switch (PlayState.SONG.song)
		{
			...
			case 'I Hate You':
				autor = 'iKenny';
			case 'Powerdown':
				autor = 'iKenny ft. Nova64 and TaeSkull';
			case 'Demise':
				autor = 'iKenny';
			case 'Alone':
				autor = 'Nova64';
	...
	public function reloadHealthBarColors()
	{
		...
		else if(curStage == 'allfinal' && gf.curCharacter == 'lg'){
	...
	override public function update(elapsed:Float)
	{
		...
		else if (curStage == 'endstage' || (curStage == 'warioworld' && PlayState.SONG.song != 'Apparition Old' && PlayState.SONG.song != 'Forbidden Star'))
		{
			...
			if (curStage == 'warioworld' && (PlayState.SONG.song != 'Apparition Old' && PlayState.SONG.song != 'Forbidden Star' && PlayState.SONG.song != 'Apparition')){
		...
		if (boyfriend.curCharacter == "bfbetaleak" && canFade){
				...
				if (!daNote.mustPress && daNote.wasGoodHit && !daNote.hitByOpponent && !daNote.ignoreNote)
				{
					...
					else if (!daNote.noAnimation)
					{
						...
						if (daNote.noteType == 'GF Sing')
						{
							...
							gf.holdTimer = 0;
							GFSINGDAD = true;
							// if (gf.curCharacter == 'lg' && curStage == 'allfinal')
							// 	{
							// 		DAD_CAM_X = 520;
							// 		DAD_CAM_Y = 350;
							// 		DAD_ZOOM = 0.7;
					...
					//	ACT 2
						switch(trigger2)
						{
							case 0:
								...
								autorText.text = 'Sandi ft. iKenny';
							...
							case 1:
								//luigi
								triggerEventNote('Change Character', '2', 'lg');
								reloadHealthBarColors();
								GF_CAM_X = 520;
								GF_CAM_Y = 350;
								GF_ZOOM = 0.7;
			...
			case 'Triggers Unbeatable':
				...
				if (!Math.isNaN(triggerMR)){
					switch (triggerMR)
					{
						...
						case 0.5:
							dad.alpha = 1;
							titleText.text = 'Unbeatable';
							autorText.text = 'Nova64 ft. TheWAHBox';
				...
				switch (triggerMR)
				{
					case 0:
						...
						if(PlayState.SONG.song == 'Unbeatable'){
							newName = titleText.text;
							Lib.application.window.title = "Friday Night Funkin': Mario's Madness | Unbeatable | Nova64 ft. TheWAHBox";
							autor = autorText.text;
	 ...
	 */
		...
		else if (curStage == "endstage" || (curStage == 'warioworld' && (PlayState.SONG.song != 'Apparition Old' && PlayState.SONG.song != 'Forbidden Star' && PlayState.SONG.song != 'Apparition')))
		{
			comboSpr.visible = false;
		}
		else if (curStage == "piracy")
